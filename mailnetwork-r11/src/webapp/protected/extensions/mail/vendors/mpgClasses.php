		...
		//print("String to be sent = " . $dataToSend);
 		...
 		curl_setopt($ch, CURLOPT_URL,$url);
  		...
  		curl_setopt($ch, CURLOPT_SSL_VERIFYPEER, TRUE);
                //Local Certificat CURL
		//curl_setopt($ch, CURLOPT_CAINFO, 'C:\wamp\bin\php\php5.5.12\data\curl-ca-bundle.crt');
                //DEV/LIVE Certificat CURL
                curl_setopt($ch, CURLOPT_CAINFO, '/etc/httpd/curl-ca-bundle.crt');
